package com.coolweater.app.activity;
...
import com.coolweater.app.model.City;
import com.coolweater.app.model.CoolWeatherDB;
import com.coolweater.app.model.County;
import com.coolweater.app.model.Province;
...
public class ChooseAreaActivity extends Activity {
    ...
    protected void onCreate(Bundle saveInstanceState){
        ...
        coolWeatherDB = CoolWeatherDB.getInstatce(this);
    ...
    private void queryFromServer(final String code, final String type){
        ...
        showProgressDialog();
        HttpUtil.sendHttpRequest(address, new HttpcCallbackListener() {
            @Override
